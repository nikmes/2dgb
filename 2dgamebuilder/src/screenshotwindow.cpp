...
ScreenShotWindow::ScreenShotWindow(TextureAtlas *textureAtlas, string name) :ImGUIComponent(textureAtlas, name)
{
	addIcons();
}
...
void ScreenShotWindow::addIcons()
{

}

void ScreenShotWindow::run(bool* opened)
{
	if (!ImGui::Begin("Screenshots", opened))
	{
		ImGui::End();
		return;
	}
